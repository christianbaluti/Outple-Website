    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[70vh] flex items-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-32">
          <div className="max-w-2xl">
            <span className="inline-block bg-white/10 text-white/80 text-sm font-semibold px-4 py-1.5 rounded-full mb-6 uppercase tracking-widest">About Outple</span>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <span className="inline-block text-[#432d7e] font-semibold text-sm tracking-widest uppercase mb-4">Our Mission</span>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">Building Bridges Between Talent and Opportunity</h2>
              ...
              <Link to={createPageUrl("HireTeam")} className="inline-flex items-center gap-2 bg-[#432d7e] text-white font-semibold px-6 py-3 rounded-full hover:bg-[#2d0a5e] transition-colors group">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="text-center p-8">
              <span className="inline-block text-purple-300 font-semibold text-sm tracking-widest uppercase mb-4">Our Vision</span>
            ...
            <div className="text-center p-8 border-t md:border-t-0 md:border-l border-white/20">
              <span className="inline-block text-purple-300 font-semibold text-sm tracking-widest uppercase mb-4">Our Mission</span>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="inline-block text-[#432d7e] font-semibold text-sm tracking-widest uppercase mb-3">What We Stand For</span>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Ready to Build Your Global Team?</h2>
          <p className="text-gray-500 text-lg mb-8">Join companies worldwide hiring smarter with Outple. Access Malawi's brightest talent.</p>
